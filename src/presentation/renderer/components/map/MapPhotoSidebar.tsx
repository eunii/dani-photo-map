...
export function MapPhotoSidebar({
  ...
  return (
    <aside className="flex h-[min(68vh,720px)] min-h-[560px] min-w-0 flex-col overflow-hidden rounded-[18px] bg-[var(--app-surface-strong)] xl:min-w-[380px]">
      ...
      <div className="flex-1 overflow-y-auto p-3">
        {selectedGroup ? (
          <div className="space-y-3">
            ...
            <section className="space-y-3 rounded-[16px] bg-[var(--app-surface)] p-3">
