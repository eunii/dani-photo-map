...
- 지역명 해석은 외부 reverse geocoding API가 아니라 curated bounding box 기반입니다. 경기도는 31개 시·군 각각에 대략적인 박스를 두었고, 서울은 자치구·미국은 주/일부 도시 등도 박스로 나눕니다. 박스 밖 좌표는 상위 광역(예: `gyeonggi-do`, `seoul`)이나 국가 단위로 떨어질 수 있습니다.
